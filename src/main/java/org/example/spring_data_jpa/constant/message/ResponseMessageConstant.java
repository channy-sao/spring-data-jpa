package org.example.spring_data_jpa.constant.message;
...
public final class ResponseMessageConstant {
  ...
  public static final String REQUEST_RESET_PASSWORD_SUCCESS =
      "You has been request to reset password!";
  ...
  public static final String REQUEST_REFRESH_TOKEN_SUCCESS =
      "You has been request to refresh token!";
  public static final String PASSWORD_CHANGED_SUCCESS = "Change password successfully!";
  public static final String CREATE_MODULE_REQUEST_SUCCESSFULLY =
      "Request Module created successfully!";

  public static final String DELETE_MODULE_REQUEST_SUCCESSFULLY =
      "Delete Request Module Successfully";
  public static final String GET_MODULE_REQUEST_SUCCESSFULLY = "Get Request Module Successfully";
  ...
  public static final String UNASSIGN_SUCCESSFULLY = "Unassign successfully";

  public static final String ERROR_OPERATION =
      "400 - "
          ...
          + OPERATION_CONFLICT
          + ", 500 - "
          + OPERATION_INTERNAL_SERVER_ERROR;
